    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">NiftyNiti</h3>
            <p className="text-gray-400">AI-powered NIFTY 50 predictions and technical analysis for better trading decisions.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://x.com/ManvirS5611830" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                <span className="sr-only">Twitter</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="https://github.com/manvirsingh1716" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              ...
              <a href="mailto:manvirsingh.main07@gmail.com" className="text-gray-400 hover:text-white">
            ...
            <p className="mt-4 text-gray-400">manvirsingh.main07@gmail.com</p>
          </div>
        </div>
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {currentYear} NiftyNiti. All rights reserved.</p>
          <p className="mt-2">Made with ❤️ by Manvir Singh</p>
        </div>
      </div>
    </footer>
  )
